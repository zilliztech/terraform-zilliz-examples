locals {
  ...
  ecr_account_id = var.customer_ecr.account_id
  ecr_region     = var.customer_ecr.region
...
DEFAULT_ZILLIZ_BYOC_IMAGE=965570967084.dkr.ecr.us-west-2.amazonaws.com/zilliz-byoc/infra/byoc-booter:$TAG
...
if [[ -z "$TAG" || "$TAG" == "None" ]]; then
  ZILLIZ_BYOC_IMAGE=$DEFAULT_IMAGE
else
