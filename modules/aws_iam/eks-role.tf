resource "aws_iam_role" "eks_role" {
  name = "zilliz-byoc-${var.name}-eks-role"
...
resource "aws_iam_policy" "cluster_autoscaler_policy" {
  name        = "zilliz-byoc-${var.name}-cluster-autoscaler-policy"
...
resource "aws_iam_policy" "aws_lb_controller_policy" {
  name        = "zilliz-byoc-${var.name}-aws-lb-controller-policy"
...
resource "aws_iam_policy" "aws_ebs_csi_controller_policy" {
  name        = "zilliz-byoc-${var.name}-ebs-csi-controller-policy"
