...
output "zilliz_private_endpoint_id" {
  ...
  value       = local.enable_private_link && local.private_endpoint_config != null ? module.zilliz_private_endpoint[0].private_endpoint_id : null
}

output "zilliz_private_endpoint_name" {
  description = "Name of the Zilliz Cloud private endpoint"
  value       = local.enable_private_link && local.private_endpoint_config != null ? module.zilliz_private_endpoint[0].private_endpoint_name : null
}

output "zilliz_private_endpoint_ip_address" {
  description = "IP address of the Zilliz Cloud private endpoint"
  value       = local.enable_private_link && local.private_endpoint_config != null ? module.zilliz_private_endpoint[0].private_endpoint_ip_address : null
  sensitive   = true
}

output "zilliz_private_dns_zone_id" {
  description = "ID of the private DNS zone for Zilliz Cloud"
  value       = local.enable_private_link && local.private_endpoint_config != null ? module.zilliz_private_endpoint[0].private_dns_zone_id : null
}

output "zilliz_private_dns_zone_name" {
  description = "Name of the private DNS zone for Zilliz Cloud"
  value       = local.enable_private_link && local.private_endpoint_config != null ? module.zilliz_private_endpoint[0].private_dns_zone_name : null
}
