...
| `customer_private_link_subnet_ids`              | The IDs of the private subnets for the private link endpoint. If not provided, will use `customer_private_subnet_ids` or default subnets | `list(string)` | `[]`                                                         | No       |
